...
================
*/
idRenderModel *idRenderModelStatic::InstantiateDynamicModel( const struct renderEntity_s *ent, const crAutoPointer<struct viewDef_s> view, idRenderModel *cachedModel ) 
{
	if ( cachedModel ) 
	{
		delete cachedModel;
