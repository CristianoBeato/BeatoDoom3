...
public:
	...
	virtual void			DebugScreenRect( const idVec4 &color, const idScreenRect &rect, const viewDefptr_t viewDef, const int lifetime = 0 );
	...
	void					WriteVisibleDefs( const viewDefptr_t viewDef );
