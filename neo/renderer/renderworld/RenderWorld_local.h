...
public:
	...
	virtual void			DebugScreenRect( const idVec4 &color, const idScreenRect &rect, const crAutoPointer<viewDef_t> viewDef, const int lifetime = 0 );
	...
	void					WriteVisibleDefs( const crAutoPointer<viewDef_t> viewDef );
