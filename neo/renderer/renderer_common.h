...
/// Render 16:9 aspect base, for easy wide screen implementation
const uint32_t 	RENDER_WIDTH = 1280;	// 
const uint32_t	RENDER_HEIGHT = 720; 	// 
...
====================================================================
*/
enum shaderStateFlags_t : uint32_t
{
	// blending source 
	GLS_SRCBLEND_ZERO						= 0x00000001,
	GLS_SRCBLEND_ONE						= 0x00000000,
	...
	GLS_DEPTHMASK							= 0x00000100,
	GLS_REDMASK								= 0x00000200,
	GLS_GREENMASK							= 0x00000400,
	GLS_BLUEMASK							= 0x00000800,
	GLS_ALPHAMASK							= 0x00001000,
	GLS_COLORMASK							= ( GLS_REDMASK | GLS_GREENMASK | GLS_BLUEMASK ),
	
	GLS_POLYMODE_LINE						= 0x00002000,
	
	GLS_DEPTHFUNC_ALWAYS					= 0x00010000,
	GLS_DEPTHFUNC_EQUAL						= 0x00020000,
	GLS_DEPTHFUNC_LESS						= 0x00000000,

	GLS_ATEST_EQ_255						= 0x10000000,
	GLS_ATEST_LT_128						= 0x20000000,
	GLS_ATEST_GE_128						= 0x40000000,
	GLS_ATEST_BITS							= 0x70000000,

	GLS_DEFAULT								= GLS_DEPTHFUNC_ALWAYS
};
